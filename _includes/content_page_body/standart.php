           ...
           <!--  <div class="pay-button transit-300">Сейчас онлайн</div> -->
                ...
                <div class="p-btn-cell">
                    <form method="POST"  class="application"  accept-charset="UTF-8" action="https://partner.rficb.ru/alba/input/">
                      ...
                      <input type="hidden" name="cost" value="17000" />
                      <input type="hidden" name="name" value="Оплата доступа по тарифу «СТАНДАРТ»" />
             ...
             <!--   <div class="pay-button-zamor transit-300">Заморозить цену</div> -->
                <div class="p-btn-cell">
                    <form method="POST"  class="application"  accept-charset="UTF-8" action="https://partner.rficb.ru/alba/input/">
                        ...
                        <input type="hidden" name="name" value="Оплата предоплаты по тарифу «СТАНДАРТ»" />
                        <input type="hidden" name="default_email" value="" />
                        <input type="hidden" name="order_id" value="0" />
