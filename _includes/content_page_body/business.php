    ...
    <div class="max-width max-content">
        ...
        <div class="full-width content-cell">
            ...
            <div class="full-width rate-title">
                ...
                Оплата доступа по тарифу «БИЗНЕС»
            ...
            <div class="full-width old-price">
                ...
                Старая цена : <span>57 000</span> рублей
        ...
        <!--        <div class="pay-button transit-300">Сейчас онлайн</div> -->
                <div class="p-btn-cell">
                    <form method="POST"  class="application"  accept-charset="UTF-8" action="https://partner.rficb.ru/alba/input/">
                      <input type="hidden" name="key" value="9ZF4nXO0C9qI1zp0bhOzzNusMerQkJ2Kw1Hc9OUmQA0=" />
                      <input type="hidden" name="cost" value="37000" />
                      <input type="hidden" name="name" value="Оплата доступа по тарифу «БИЗНЕС»" />
                      <input type="hidden" name="default_email" value="" />
                      <input type="hidden" name="order_id" value="0" />
                      <input type="submit" id="a1lite_button" tyle="border:0;" class="pay-button transit-300" value="Сейчас онлайн"/>
                    </form>
                </div>
                ...
                <div class="p-btn-cell">
                    <form method="POST"  class="application"  accept-charset="UTF-8" action="https://partner.rficb.ru/alba/input/">
                      ...
                      <input type="hidden" name="name" value="Оплата предоплаты по тарифу «БИЗНЕС»" />
                      <input type="hidden" name="default_email" value="" />
                      <input type="hidden" name="order_id" value="0" />
                      <input type="submit" id="a1lite_button" tyle="border:0;" class="pay-button-zamor transit-300" value="Заморозить цену"/>
                    </form>
                </div>
